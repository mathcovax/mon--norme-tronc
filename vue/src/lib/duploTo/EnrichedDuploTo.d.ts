...
export type request_body_32 = string
...
export type response_body_32_2 = string
...
export type response_body_84_10 = {
    id: number;
    productSku: string;
    reason: string;
    status: "WAITING_RETURN" | "REFUNDED" | "INVALID";
...
export type response_body_102_5 = {
    id: number;
    idShip: string;
    carrierName: "LA_POSTE";
    commandId: string;
