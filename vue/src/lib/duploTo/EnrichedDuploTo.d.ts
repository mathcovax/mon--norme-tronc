...
export type response_body_14_0 = ({
...
export type response_body_15_6 = {
    userId: string;
    productSheetId: string;
    quantity: number;
    createdAt?: string;
...
export type response_body_78_0 = ({
    type: "CHECKBOX" | "RADIO";
    name: string;
    values: {
        value: string;
...
export type response_body_79_0 = string
