...
export type response_body_32_3 = {
    ...
    emailNotifcationsNewProductsInCategory: boolean;
...
export type request_body_33 = {
    ...
    emailNotifcationsNewProductsInCategory?: boolean | undefined;
}
...
export type response_body_83_2 = {
    id: string;
    ref: string;
    name: string;
    price: number;
