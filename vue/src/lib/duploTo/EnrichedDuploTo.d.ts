...
export type response_body_40_4 = string
...
export type response_body_100_5 = {
    id: number;
    idShip: string;
    carrierName: "LA_POSTE";
    commandId: string;
...
export type response_body_102_2 = {
    id: string;
    ref: string;
    name: string;
    price: number;
...
export type response_body_107_0 = string
