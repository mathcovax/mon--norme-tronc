...
export type response_body_35_1 = {
    _id: string;
    userId: string;
    productSheetId: string;
    pseudo: string;
...
export type response_body_79_10 = {
    id: number;
    productSku: string;
    reason: string;
    status: "WAITING_RETURN" | "REFUNDED" | "INVALID";
...
export type response_body_101_5 = {
    id: number;
    idShip: string;
    carrierName: "LA_POSTE";
    commandId: string;
...
export type response_body_114_4 = string

export type response_114_4 = {
    code: 201;
    ok: true;
    info: "user.registered";
} & {body: response_body_114_4};
