...
export type response_62_9 = {
    code: 404;
    ok: false;
    info: "commandItem.missing";
} & {body: undefined};

export type response_62_10 = {
    code: 404;
    ok: false;
    info: "product.missing";
} & {body: undefined};

export type response_62_11 = {
    code: 409;
    ok: false;
    info: "commandItem.alreadyCompleted";
} & {body: undefined};

export type response_62_12 = {
    code: 409;
    ok: false;
    info: "commandItem.tooMuch.product";
} & {body: undefined};

export type response_62_13 = {
    code: 200;
    ok: true;
    info: "makeBundle";
} & {body: undefined};
...
export type response_body_69_8 = {
    id: number;
    productSku: string;
    reason: string;
    status: "WAITING_RETURN" | "REFUNDED" | "INVALID";
...
export type response_body_88_0 = string

export type response_88_0 = {
    code: 200;
    ok: true;
    info: "fullProductSheetCount";
} & {body: response_body_88_0};
