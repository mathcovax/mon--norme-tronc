...
=======
=======
>>>>>>> 38b35f0 (feat(142): update newsletters)
...
export type response_body_25_6 = {
    sessionUrl: string;
}
...
export type response_body_32_1 = {
    _id: string;
    userId: string;
    productSheetId: string;
    pseudo: string;
...
export type response_body_37_4 = string
...
export type response_body_106_0 = string
...
export type response_body_107_0 = ({
    type: "CHECKBOX" | "RADIO";
    name: string;
    values: {
        value: string;
