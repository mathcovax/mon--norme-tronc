...
export type response_body_54_7 = {
    id: string;
    ref: string;
    name: string;
    description: string;
...
export type response_57_11 = {
    code: 409;
    ok: false;
    info: "commandItem.alreadyCompleted";
} & {body: undefined};

export type response_57_12 = {
    code: 409;
    ok: false;
    info: "commandItem.tooMuch.product";
} & {body: undefined};

export type response_57_13 = {
    code: 200;
    ok: true;
    info: "makeBundle";
} & {body: undefined};
...
export type response_body_82_2 = {
    id: string;
    ref: string;
    name: string;
    price: number;
...
export type response_body_87_0 = ({
    type: "CHECKBOX" | "RADIO";
    name: string;
    values: {
        value: string;
...
export type response_body_89_0 = string
