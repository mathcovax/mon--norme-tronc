...
export const createdCommandTemplate = (username: string, commandId: string, url: string) => baseTemplate(/* html */`
<p style="margin: 0 0 1rem;">Bonjour <b>${ username }</b>,</p>
<p style="margin: 0 0 1rem;">Votre commande <strong>n°${ commandId }</strong> a été créée avec succès.</p>
